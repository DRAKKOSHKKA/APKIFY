...
<p align="center">
  <img src="https://img.shields.io/badge/Версия-v1.B3-007AFF?style=for-the-badge&logo=apple" alt="Version" />
...
- **Автоопределение текущей пары**: живой индикатор с обратным отсчетом времени (*«Идёт • ост. 24 мин»*) и анимированным прогресс-баром.
...
- **Оповещение о начале дня**: если первой пары нет, приложение заботливо подсказывает: *«Первой пары нет — ко 2-й паре (к 09:30)»*.
...
## 🆕 Что нового в версии V1.B3

1. **Новый дизайн вкладки Настройки**:
   - Вкладка переименована из «Профиль» в «Настройки» с системной иконкой шестерёнки.
   - Убран дублирующий выбор группы — поиск и смена группы теперь удобно выполняются прямо из шапки расписания.
2. **Скрытие меню разработчика**:
   - Панель отладки убрана из видимого меню настроек и доступна только по секретному жесту (7 тапов по версии).
3. **Адаптация под iPad и экраны больших диагоналей**:
   - Все экраны, шапка, таб-бар и модальные окна получили адаптивную колоночную вёрстку.
4. **Улучшение компоновки шапки дня**:
   - Кнопка «Поделиться» переработана в компактную иконку, больше не вытесняющую кнопку «Сегодня».
5. **Темы оформления и защита текста**:
   - Добавлена тема OLED True Black и расширенная палитра акцентов.
   - Все кнопки и бейджи защищены от переносов и переполнения текста.
...
1. Скачайте `Apkify.ipa` из последнего [Релиза v1.B3](https://github.com/DRAKKOSHKKA/apkify/releases).
